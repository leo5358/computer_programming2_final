...
Animation id: attack-light
Animation prompt: quick katana slash with clear anticipation, committed swing, and readable recovery
Frame count: 12
...
Layout requirements:
- Output exactly 12 complete full-body frames in a single horizontal row.
- Treat the image as 12 equal-width invisible frame slots.
