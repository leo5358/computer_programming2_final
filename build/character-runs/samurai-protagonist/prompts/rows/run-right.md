...
Animation id: run-right
Animation prompt: side-view running right, compact stride, grounded samurai footwork
Frame count: 8
...
Layout requirements:
- Output exactly 8 complete full-body frames in a single horizontal row.
- Treat the image as 8 equal-width invisible frame slots.
