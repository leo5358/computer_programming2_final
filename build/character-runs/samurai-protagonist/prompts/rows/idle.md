...
Animation id: idle
Animation prompt: calm combat breathing stance, hand near the sword, subtle cloth movement
Frame count: 4
...
Layout requirements:
- Output exactly 4 complete full-body frames in a single horizontal row.
- Treat the image as 4 equal-width invisible frame slots.
